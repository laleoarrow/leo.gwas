...
#'
#' @param dir Character. The directory containing SMR result files. Files 
#'            should have the `.smr` extension and follow the naming convention `exposure@outcome.smr`.
...
#' @param pattern Character. A regular expression pattern to match SMR result files. 
